...
This uses the following defaults in addition to the default behaviour of each 
included function:
...
melting-point curves will all be plotted. Default *FALSE*.

The (integer) argument *max_cores* is passed to curve-fitting methods and 
defines maximum parallel cores to use for these operations. Default *4*.
